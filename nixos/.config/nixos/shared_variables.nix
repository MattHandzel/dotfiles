{
  ...
  singletonApplications = ["calendar" "cura" "obsidian" "slack" "btop" "notetaker" "nautilus" "wasistlos" "io.github.alainm23.planify" "anki" "planify" "PrusaSlicer" "discord" "thunderbird" "gimp" "yazi"];
