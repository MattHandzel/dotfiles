{
  ...
  singletonApplications = ["calendar.google.com" "reclaim" "cura" "obsidian" "slack" "btop" "notetaker" "nautilus" "whatsapp-for-linux" "io.github.alainm23.planify" "anki" "planify" "PrusaSlicer" "discord" "thunderbird" "gimp" "yazi" "vit-todo"];
