...
_: {
  home.file.".aerospace.toml".text = ''
    ...
    after-startup-command = [
      ...
      'exec-and-forget /opt/homebrew/bin/borders active_color=0xffcba6f7 inactive_color=0xff45475a width=2.0',
    ]
    ...
    on-focused-monitor-changed = ['move-mouse monitor-lazy']
